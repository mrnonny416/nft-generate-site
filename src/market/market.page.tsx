    ...
    return (
        <div className="flex flex-col w-full h-screen relative">
            ...
            <div className="flex flex-rows justify-around mt-[10px] w-full">
                <div className="flex flex-col justify-center items-center bg-white w-[45%] max-w-[500px] rounded-lg ">
                    <div className="flex flex-col justify-center items-center bg-white w-full rounded-lg m-3">
                        <Image src={Kapom} alt="Kapom" className="w-full" />
                        <span className="pl-2 text-black">Project Name</span>
                        <div className="flex flex-rows justify-center items-center bg-black/60 w-[95%] rounded-lg mt-3">
                            <div>
                        ...
                        <div className="flex flex-rows justify-center items-center bg-white border-2 border-mainGreen w-[95%] h-[50px] rounded-lg mt-1">
