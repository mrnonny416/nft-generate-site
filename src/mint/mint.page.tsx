...
const Mint = () => {
    ...
    return (
        <div>
            ...
            {showMintState && (
                <div className='h-[419px] w-[450px] m-auto flex justify-center items-center'>
                    <div className='border border-mainGreen rounded-md w-full h-fit py-2'>
            ...
            {!showMintState && (
                <div className='h-[419px] w-[450px] m-auto flex justify-center items-center'>
                    <div className='border border-mainGreen rounded-md h-fit p-4 grid gap-y-4'>
                        <div className='flex gap-x-10'>
                            <button className='flex bg-mainGreen w-[40px] h-[40px] p-3 gap-4 rounded m-auto text-black justify-center items-center' onClick={onMinus}> - </button>
                            <div className='flex bg-mainGreen w-[40px] h-[40px] p-3 gap-4 rounded m-auto text-black justify-center items-center'> {count} </div>
                            <button className='flex bg-mainGreen w-[40px] h-[40px] p-3 gap-4 rounded m-auto text-black justify-center items-center' onClick={onPlus}> + </button>
                        </div>
                        <div>
                            <button className='flex bg-mainGreen w-[40px] h-[40px] p-3 gap-4 rounded m-auto text-black justify-center items-center' onClick={() => setShowMintState(true)}> Mint </button>
                        </div>
