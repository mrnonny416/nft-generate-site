    ...
    return (
        <div>
            ...
            <div className='p-3 grid gap-y-4 max-w-[500px] m-auto'>
                ...
                <Link href={{ pathname: '/dashboard', query: { item: '01' } }} className="cursor-pointer bg-mainGreen text-black py-2 px-4 rounded-md text-center" >
                    Submit
                </Link>
                <Link href={{ pathname: '/dashboard' }} onClick={onCancel} className="cursor-pointer bg-black border-2 border-[#FF2E00] text-[#FF2E00] py-2 px-4 rounded-md text-center" >
                    Delete
                </Link>
            </div>
        </div>
